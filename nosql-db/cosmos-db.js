...
class CosmosDB extends NoSqlDB {
    async init() {
        ...
        try {
            ...
            /* schemaContainer = await this.createContainer(schemaContainerId);
            revokedCredentialContainer = await this.createContainer(revokedCredentialContainerId);
            keysContainer = await this.createContainer(keysContainerId);
            metadataContainer = await this.createContainer(metadataContainerId);*/
        } catch(err) {
